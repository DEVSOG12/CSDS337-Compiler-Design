...
// An expression that multiplies two operands.
...
public:
    ...
    // a1: Left side expression of the multiplication statement.
    // a2: Right side expression of the multiplication statement.
    static std::unique_ptr<ASTExpressionMultiplication> Create(std::unique_ptr<ASTExpression> a1, std::unique_ptr<ASTExpression> a2) {
...
private:
    // Left side expression of the multiplication statement.
    std::unique_ptr<ASTExpression> a1;
    // Right side expression of the multiplication statement.
