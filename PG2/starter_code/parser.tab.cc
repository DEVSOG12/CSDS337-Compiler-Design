...
{
       0,    91,    91,    96,   100,   108,   113,   116,   122,   129,
     136,   137,   188
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "IF", "ELSE", "EQUALS_SIGN", "VARIADIC", "INT_LITERAL",
  "STRING_LITERAL", "FLOAT_LITERAL", "BOOL_LITERAL", "LPAREN", "RPAREN",
  "LBRACE", "RBRACE", "ARITH_MINUS", "$accept", "program", "decList",
  "dec", "type", "funDec", "funDef", "params", "id", YY_NULLPTR
};
...
#line 91 "parser.y"
  ...
  add_child(root, (yyvsp[0].nodeval));
 }
...
#line 100 "parser.y"
  ...
  (yyval.nodeval) = make_node_str("decList");
  //Again, after making the current node, add the children:
  add_child((yyval.nodeval), (yyvsp[-1].nodeval));
  add_child((yyval.nodeval), (yyvsp[0].nodeval));
 }
...
#line 113 "parser.y"
            {
  (yyval.nodeval) = make_node_str("dec");
  add_child((yyval.nodeval), (yyvsp[0].nodeval));
 }
...
#line 122 "parser.y"
               {
  (yyval.nodeval) = make_node_str("type_int");
 }
#line 1449 "parser.tab.cc"
    break;

  case 9: /* funDec: type id LPAREN params RPAREN SEMICOLON  */
#line 129 "parser.y"
                                               {
  //This defines a production for a function declaration (not a definition).
  (yyval.nodeval) = make_node_str("funDec");
  add_child((yyval.nodeval), (yyvsp[-5].nodeval));
  add_child((yyval.nodeval), (yyvsp[-4].nodeval));
  add_child((yyval.nodeval), (yyvsp[-2].nodeval));
 }
#line 1461 "parser.tab.cc"
  ...
  case 12: /* id: ID  */
#line 188 "parser.y"
       {(yyval.nodeval) = make_node_str((yyvsp[0].strval));}
